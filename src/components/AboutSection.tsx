                ...
                <div className="bg-bg-item-surface rounded-xl border border-border-subtle overflow-hidden">
                    <div className="p-3 border-b border-border-subtle bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h5 className="text-sm font-bold text-text-primary mb-1">Capture & Analyse — {getPlatformShortcut(['⌘', 'Shift', 'Enter']).join(isMac ? '' : '+')}</h5>
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    One shortcut to screenshot your screen and instantly get AI analysis. No extra clicks — press {getPlatformShortcut(['⌘', 'Shift', 'Enter']).join(isMac ? '' : '+')} and Natively does the rest.
                                </p>
                            </div>
                        </div>
                    </div>
